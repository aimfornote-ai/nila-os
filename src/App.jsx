      ...
      <div style={{ padding:"0 40px 80px", display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:24 }}>
        {[
          ...
          { name:"Lotus Blush",    motif:"Dok Mali · ดอกมะลิ",   era:"Central Plains Heritage",   palette:"Lotus Blossom + Antique Gold + Linen",
            ...
            imageUrl: null,
            desc:"The jasmine blossom of maternal devotion — reimagined as a flowing organic botanical." },
          { name:"Royal Azure",    motif:"Naga Scale · เกล็ดนาค", era:"Khmer-Thai, 12th century",  palette:"Deep Emerald + Ivory + Gold",
            surfaces:"Wall Tile · Architectural · Fashion",   status:"Coming Q4 2026", statusColor:T.mist,
            imageUrl: null,
            desc:"Mathematical serpent scales — sacred geometry for architectural and fashion applications." },
        ].map((c,i)=>(
